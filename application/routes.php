...
Route::get('author/new', array('as' => 'new_author', 'uses' => 'authors@new'));
Route::post('authors/create', array('before' => 'csrf', 'uses' => 'authors@create'));
Route::get('author/edit/(:any)', array('as' => 'edit_author', 'uses' => 'authors@edit'));
Route::post('authors/update', array('before' => 'csrf', 'uses' => 'authors@update'));
Route::get('author/delete/(:any)', array('as' => 'delete_author', 'uses' => 'authors@delete'));